...
const Repository: React.FC<RepositoryProps> = () => {
  return (
    <div className="border-b border-solid border-header-icon pt-6">
      ...
      <div className="flex border border-solid border-header-icon bg-profile-button rounded-md  py-1 w-fit">
