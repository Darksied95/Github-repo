  ...
  return (
    <div className="">
      ...
      <div className="text-primary">
        <button className="border border-solid border-header-icon rounded-md w-full flex items-center gap-2 text-secondary font-thin text-sm p-1 ">
        ...
        <p className="my-2">I&apos;m a frontend developer from Nigeria.</p>
        ...
        <div className="flex items-center border-b border-solid border-header-icon pb-10">
